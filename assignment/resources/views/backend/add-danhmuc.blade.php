        ...
        <div>
            <div class="card">
                ...
                <div class="card-body card-block">
                    ...
                    <div class="col-12 col-md-9"><input type="text" id="text-input" name="tendm" placeholder="Nhập tên danh mục" class="form-control" value="{{ old('tendm') }}"></div>
                    </div>
