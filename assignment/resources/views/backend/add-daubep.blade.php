        ...
        <div>
            <div class="card">
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" value="{{old('hoten')}}" id="text-input" name="hoten" placeholder="Nhập họ tên" class="form-control"></div>
                @if($errors->has('hoten'))
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="email" value="{{old('email')}}" id="text-input" name="email" placeholder="Nhập email" class="form-control"></div>
                @if($errors->has('email'))
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="number" value="{{old('sdt')}}" id="text-input" name="sdt" placeholder="Nhập số điện thoại" class="form-control"></div>
                @if($errors->has('sdt'))
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" value="{{old('diachi')}}" id="text-input" name="diachi" placeholder="Nhập địa chỉ" class="form-control"></div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9"><input type="text" value="{{old('chucvu')}}" id="text-input" name="chucvu" placeholder="Nhập chức vụ" class="form-control"></div>
                ...
                <div class="row form-group">
                    ...
                    <div class="col-12 col-md-9">
                        <textarea class="form-control" id="summary-ckeditor" name="gioithieu"></textarea>
