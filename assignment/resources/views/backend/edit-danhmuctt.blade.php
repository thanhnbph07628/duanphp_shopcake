        ...
        <div>
            <div class="card">
                <div class="card-header">
                    <strong>Sửa danh mục tin tức</strong>
                    <a href="{{route('danhmuctt')}}"><button type="submit" style="width: 100px"><i class="fa fa-mail-reply mr-sm-2"></i>Quay lại</button></a>
                </div>
                <div class="card-body card-block">
                <form action="{{route('posteditdanhmuctt',['id'=>$laydulieu->id])}}" method="post" enctype="multipart/form-data" class="form-horizontal">
                    @csrf
                    <div class="row form-group">
                    <div class="col col-md-3"><label for="text-input" class=" form-control-label">Tên danh mục</label></div>
                    <div class="col-12 col-md-9"><input type="text" id="text-input" value="{{$laydulieu->tendm}}" name="tendm" placeholder="Nhập tên danh mục" class="form-control"></div>
                    </div>
